...
The sentence generator (`imagining_syntax.data.sentences`) creates sentences
with this structure:
...
because the generator enforces uniqueness against a 12,000-sentence target —
so the 40-or-so possible 3-word sentences saturate quickly.
