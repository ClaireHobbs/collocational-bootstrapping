...
Experiment 2 measures the Zipfian parameter present in real caregiver 
speech. Experiment 1 measures how that parameter affects what a neural 
learner can generalize. Together they let us ask whether the distributional 
word co-occurrence in child-directed speech is in a range that supports 
